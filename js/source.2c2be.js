...
exports.BaseTaskModel = exports.filterTasksByMessage = exports.sortTasksByGroup = exports.sortTasksByDate = void 0;

var _moment = _interopRequireDefault(__webpack_require__(9));
...
const filterTasksByMessage = (tasks, value) => {
  if (!tasks) return [];
  const filtered = tasks.filter(task => ~task.message.toLowerCase().indexOf(value));
  return [...filtered];
};

exports.filterTasksByMessage = filterTasksByMessage;
...
var _withSvg = __webpack_require__(1);
...
var _Footer = _interopRequireDefault(__webpack_require__(32));

var _TaskList = _interopRequireDefault(__webpack_require__(42));

var _NewTask = _interopRequireDefault(__webpack_require__(49));

var _Spinner = _interopRequireDefault(__webpack_require__(50));

var _helpers = __webpack_require__(2);

var _stylesM = _interopRequireDefault(__webpack_require__(13));

var _REST = __webpack_require__(53);
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_addNewTask", message => {
      const tasks = [...this.state.tasks];
      this.setState({
        fetchInProgress: true
      });

      _REST.api.createTasks({
        message
      }).then(data => {
        this.setState({
    ...
    _defineProperty(this, "_updateTask", newTask => {
      _REST.api.updateTask([newTask]).then(data => {
        this.setState({
          fetchInProgress: false
        });
        this.setState({
    ...
    _defineProperty(this, "_deleteTask", deletedTask => {
      _REST.api.deleteTask(deletedTask).then(() => {
        this.setState({
          fetchInProgress: false
        });
        this.setState({
    ...
    _defineProperty(this, "_completeAllTasks", () => {
      ...
      _REST.api.updateTask(tasks).then(data => {
        this.setState({
          fetchInProgress: false
        });
        this.setState({
    ...
    _defineProperty(this, "_getUncompletedTasks", () => {
      return this.state.tasks.filter(task => !task.completed);
    });

    _defineProperty(this, "_updateTasksFilter", value => {
      this.setState({
        searchValue: value
      });
    });
  ...
  componentDidMount() {
    ...
    _REST.api.fetchTasks().then(data => {
      this.setState({
        fetchInProgress: false,
        tasks: data
      });
  ...
  render() {
    ...
    return _react.default.createElement("section", {
      ...
      isSpinning: this.state.fetchInProgress
    }), _react.default.createElement(_Header.default, {
      searchValue: this.state.searchValue,
      _updateTasksFilter: this._updateTasksFilter
    }), _react.default.createElement("section", null, _react.default.createElement(_NewTask.default, {
      _addNewTask: this._addNewTask
    }), _react.default.createElement(_TaskList.default, {
      tasks: (0, _helpers.filterTasksByMessage)(this.state.tasks, this.state.searchValue),
...
Object.defineProperty(exports, "filterTasksByMessage", {
  enumerable: true,
  get: function () {
    return _helpers.filterTasksByMessage;
  }
});
...
var _Task = _interopRequireDefault(__webpack_require__(43));
...
class TaskList extends _react.Component {
  render() {
    return _react.default.createElement("div", null, _react.default.createElement("ul", null, _react.default.createElement("div", null, (0, _helpers.sortTasksByGroup)(this.props.tasks).map(task => {
...
var _Star = _interopRequireDefault(__webpack_require__(46));
...
class Task extends _react.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "messageInput", _react.default.createRef());

    _defineProperty(this, "_resetMessage", () => {
      this.setState({
        message: this.props.message
      });
    });

    _defineProperty(this, "_setTaskEditingState", () => {
      this.setState({
    ...
    _defineProperty(this, "_updateTaskMessage", message => {
      this.props._updateTask(_objectSpread({}, this._getTaskShape(this.props), {
        message
      }));
    });

    _defineProperty(this, "_toggleTaskCompeting", e => {
      e.preventDefault();
    ...
    _defineProperty(this, "_toggleTaskFavorite", e => {
      e.preventDefault();
    ...
    _defineProperty(this, "_handleOnChange", e => {
      this.setState({
  ...
  render() {
    ...
    return _react.default.createElement("li", {
      className: `${_stylesM.default.task} ${completed ? _stylesM.default.completed : ""}`
...
class NewTask extends _react.Component {
  constructor(...args) {
    super(...args);
...
const api = {
  fetchTasks: () => fetch(_config.MAIN_URL, {
    method: "GET",
    headers
  }).then(response => response.json()).then(response => response.data),
  createTasks: message => fetch(_config.MAIN_URL, {
    method: "POST",
    headers,
    body: JSON.stringify(message)
  }).then(response => response.json()).then(response => response.data),
  updateTask: task => fetch(_config.MAIN_URL, {
    method: "PUT",
    headers,
    body: JSON.stringify(task)
  }).then(response => response.json()).then(response => response.data),
  deleteTask: data => fetch(`${_config.MAIN_URL}/${data.id}`, {
    method: "DELETE",
    headers
  }).then(response => response.json()).then(response => response.data)
};
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.2c2be.js.map